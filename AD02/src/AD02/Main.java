...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("1-Engadir unha tenda.\r\n" + 
				"2-Eliminar unha tenda (elim�nanse t�dolos productos e empragados desta).\r\n" + 
				...
				"10-Ler os titulares do peri�dico El Pa�s\r\n" + 
				"11-Sair do programa.");
		...
		case 4:
			if(compania.tendas.size()>0) {
				...
				if(compania.tendas.get(tendaElexida).productos.size()>0) {
					...
					System.out.println("Non hai ning�n producto");
				}
			}else {
				System.out.println("Non hai creada ningunha tenda");
			}
		...
		case 9:
	        ...
	        if(arquivoCopia.exists()) {
	        	...
	        	System.out.println("Ocorreu alg�n erro e non se realizou a copia");
	        }
